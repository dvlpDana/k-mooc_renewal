    ...
    <section className={styles.secSignUp}>
      ...
      <div className={styles.memberClassfication}>
        <div className={styles.audultMember}>
          ...
          <img src={`${process.env.PUBLIC_URL}/img/join_type01.png`} alt="joinImg" />
          <button className={styles.btnJoin} type="submit" data="audult" onClick={() => { navigate("/sign-up/step1") }}>가입하기</button>
        </div>
        <div className={styles.childMember}>
          ...
          <img src={`${process.env.PUBLIC_URL}/img/join_type02.png`} alt="joinImg" />
          <button className={styles.btnJoin} type="submit" data="child" onClick={() => { navigate("/sign-up/step1") }}>가입하기</button>
        </div>
      </div>
    </section>
  );
    ...
    <section className={styles.secFirstStep}>
      ...
      <div className={styles.selfAuthenticationArea}>
        ...
        <div className={styles.btnSelfCon}>
          <button className={`${styles.btnWide} ${styles.btnSelf}`} onClick={() => { navigate("/sign-up/step2") }}>
            <FontAwesomeIcon icon={faMobileScreen} />
            <span>휴대폰 번호로 본인 인증</span>
          </button>
          <span className={styles.notiSelf}>( <strong>*</strong> 본인 폰으로만 본인 인증 가능합니다)</span>
          <button className={`${styles.btnWide} ${styles.btnSelf}`} onClick={() => { navigate("/sign-up/step2") }}>
    ...
    <section className={styles.secSecondStep}>
      ...
      <div className={styles.joinInfoArea}>
        <h2>
          ...
          <span>(<strong> * </strong> 는 필수 입력 항목입니다.)</span>
        </h2>
        <form action="/" method="post" name="join_form">
          ...
          <section className={styles.joinForm}>
            ...
            <div className={styles.inputTxtBox}>
              ...
              <input type="text" className={styles.inputTxt} id={styles.userCountry} placeholder="출신 국가명"></input>
            </div>
            <div className={styles.inputTxtBox}>
              <label htmlFor="userCity" className={styles.inputHeader}>도시 또는 거주 지역 <span>(선택)</span></label>
              <input type="text" className={styles.inputTxt} id={styles.userCity} placeholder="살고 있는 도시명 또는 지역명"></input>
            </div>
            <div className={styles.inputTxtBox}>
              <label htmlFor="userDegree" className={styles.inputHeader}>최종학력 <span>(선택)</span></label>
              <input type="text" className={styles.inputTxt} id={styles.userDegree} placeholder="최종학력"></input>
            </div>
            <div className={styles.inputTxtBox}>
              <label htmlFor="causeInterest" className={styles.inputHeader}>K-MOOC에 관심을 갖게 된 이유 <span>(선택)</span></label>
              <textarea type="text" className={styles.textArea} id={styles.causeInterest} placeholder="K-MOOC에 관심을 갖게 된 계기를 간단히 기입해주세요."></textarea>
            </div>
            <div className={styles.inputTxtBox}>
              <h3 className={styles.inputHeader}>광고성 메세지에 대한 정보 수신 동의</h3>
              <div className={styles.checkBox}>
                <input type="checkbox" id={styles.bothEmailSms} value="bothEmailSms" />
              ...
              <p className={styles.inputExplanationCon}>
                <span className={styles.inputExplanation}>* 회원가입, 비밀번호, 학습하시는 강좌와 관련된 이메일, SMS는 정보 수신 동의여부와 관계없이 발송됩니다</span>
                <span className={styles.inputExplanation}>* 신규강좌, 이벤트에 대한 마케팅 정보 및 알림 메시지 수신을 동의합니다</span>
            ...
            <div className={styles.inputTxtBox}>
              ...
              <div className={styles.termsCheckBox}>
                <input type="checkbox" id={styles.bothAgree} value="bothAgree" />
                <label htmlFor="bothAgree">전체 동의하기</label>
              </div>
              <div className={styles.termsCheckBox}>
                <input type="checkbox" id={styles.firstTerms} value="firstTerms" />
                <label htmlFor="firstTerms">(필수) 이용약관 및 위치 정보이용약관</label>
                <span>내용 보기</span>
              </div>
              <div className={styles.termsCheckBox}>
                <input type="checkbox" id={styles.secondTerms} value="secondTerms" />
                <label htmlFor="secondTerms">(필수) 개인정보 수집 ∙ 이용에 관한 동의</label>
                <span>내용 보기</span>
              </div>
            </div>
...
const ThirdSignUp = () => {
  ...
  return (
    <section className={styles.secThirdStep}>
      <StatusBar />
      <h2>K-MOOC 회원가입이<br />완료되었습니다</h2>
      <h3>다양한 학습을 시작해보세요</h3>
      <span>아이디 : userID@domain.com</span>
      <button
        type="submit"
        value="Sign in"
  ...
  return (
    <>
      <ul className={styles.statusBar}>
        <li onClick={() => { navigate("/sign-up/step1") }}>
          <strong>STEP 1</strong>
          <span className={styles.firstStep}>회원가입 방법 선택</span>
        </li>
        <li onClick={() => { navigate("/sign-up/step2") }}>
          <strong>STEP 2</strong>
          <span className={styles.secondStep}>회원가입 정보 입력<br /> 및 약관 동의</span>
        </li>
        <li onClick={() => { navigate("/sign-up/step3") }}>
...
export { SignUp, FirstSignUp, SecondSignUp, ThirdSignUp };